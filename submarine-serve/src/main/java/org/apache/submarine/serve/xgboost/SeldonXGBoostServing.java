 ...
 * under the License.
 */
package org.apache.submarine.serve.xgboost;
...
public class SeldonXGBoostServing extends SeldonDeployment {
  public SeldonXGBoostServing(String name, String modelURI){
